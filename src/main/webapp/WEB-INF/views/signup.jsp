			...
			<table>
				<tr>
					...
					<td>
						...
						<button class="checkBtn" name="idCheckBtn" id="idCheckBtn">중복확인</button>
					</td>
				</tr>
				<tr>
					<td>이메일 </td>
					<td>
						...
						<button class="checkBtn" name="emailCheckBtn" id="emailCheckBtn">중복확인</button>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						...
						<button class="checkBtn" name="mobileCheckBtn" id="mobileCheckBtn">중복확인</button>
					</td>
				</tr>
			</table>
